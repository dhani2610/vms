        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                <div class="card">
                    <div class="card-body">
                        <div class="container"
                            style="word-break: break-all; max-width: 100%; width: 100%; max-height: 800px; overflow-x: auto; overflow-y: auto; box-sizing: border-box;">
                            {{-- <center>
                                <img src="{{ asset('assets/img/cover/' . $materi->image_cover) }}" alt=""
                                    style="max-width: 100%;">
                            </center> --}}
                            {!! $materi->content !!}
                        </div>
