...
@section('content')
    ...
    <div class="main-content-inner">
        <div class="row">
            <form action="{{ route('fungsi.update', $fungsi->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="col-12 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title text-center">Edit Fungsi</h4>
                            <hr>
                            <div class="col-lg-12">
                                <div class="form-group col-md-12">
                                    <label class="mt-2" for="judul">Fungsi</label>
                                    <input type="text" class="form-control" id="fungsi" name="fungsi" value="{{ $fungsi->fungsi }}" required>
                                </div>
