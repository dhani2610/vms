...
class AdminsController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['admins'] = Admin::where('type',null)->get();
        $data['roles']  = Role::all();
        return view('backend.pages.admins.index', $data);
    }
    public function vendor()
    {
        $data['admins'] = Admin::where('type','vendor')->get();
        return view('backend.pages.admins.vendor', $data);
    }
    ...
    public function updateVerifikasi(Request $request, int $id)
    {
        $admin = Admin::find($id);
        $admin->status_verifikasi = $request->status_verifikasi;
        $admin->save();
